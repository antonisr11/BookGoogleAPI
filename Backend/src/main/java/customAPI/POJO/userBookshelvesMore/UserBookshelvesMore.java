package customAPI.POJO.userBookshelvesMore;
...
public class UserBookshelvesMore {
    ...
    public String toString() {
        ...
        sb.append(UserBookshelvesMore.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("kind");
        sb.append('=');
